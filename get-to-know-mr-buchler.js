(function () {
    ...
    var translations = {
        ...
        es: {
            ...
            startTitle: 'Buenos Lugares para Comenzar', surveyTitle: 'Comparte Tus Intereses y Metas', surveyText: 'Completa la encuesta de personalizacion de cinco minutos.', scheduleTitle: 'Planea Tu Horario en el Centro', scheduleText: 'Dime que dias y horarios funcionan mejor.', exploreTitle: 'Explora Oportunidades', exploreText: 'Encuentra programas, opciones universitarias y formas de desarrollar habilidades.', zoomTitle: 'Entra al Zoom del Sr. Buchler', zoomText: 'Asegurate de programar una cita con anticipacion. El Sr. Buchler no siempre esta esperando en la sala de Zoom.',
