(function () {
    ...
    var es = {
        ...
        'Noticeboard': 'Tablero',
        'Courses': 'Cursos',
        'Signup Help': 'Ayuda para Inscribirse',
        ...
        'Get Signup Help': 'Obtener Ayuda para Inscribirse',
        ...
        'Need Help Signing Up?': 'Necesitas Ayuda para Inscribirte?',
        'Get virtual help from Amanda Rondinelli, Early College Credit Program Assistant. Students can drop into Friday office hours or schedule a private appointment for application, registration, and college-success support.': 'Recibe ayuda virtual de Amanda Rondinelli, Asistente del Programa de Credito Universitario Temprano. Los estudiantes pueden entrar a las horas de oficina del viernes o programar una cita privada para recibir apoyo con solicitudes, inscripcion y exito universitario.',
        'Your support contact': 'Tu contacto de apoyo',
        'Amanda Rondinelli': 'Amanda Rondinelli',
        'Early College Credit Program Assistant': 'Asistente del Programa de Credito Universitario Temprano',
        'Get help with:': 'Recibe ayuda con:',
        'College applications and course registration': 'Solicitudes universitarias e inscripcion en cursos',
        'Connecting to Altus and college resources': 'Conexion con recursos de Altus y de la universidad',
        'Academic coaching for success in college courses': 'Orientacion academica para tener exito en cursos universitarios',
        'Time management and organization': 'Manejo del tiempo y organizacion',
        'Requesting official transcripts': 'Solicitud de expedientes academicos oficiales',
        'Communicating issues to partner colleges': 'Comunicar problemas a las universidades asociadas',
        'What this support does not cover': 'Lo que este apoyo no incluye',
        'Course planning remains a team decision with the counselor, teacher, school leader, student, and parent. Amanda does not provide academic tutoring or directly troubleshoot college platforms, but she can connect students to the right support and escalate platform issues.': 'La planificacion de cursos sigue siendo una decision en equipo con el consejero, maestro, lider escolar, estudiante y padre o madre. Amanda no ofrece tutoria academica ni resuelve directamente problemas de las plataformas universitarias, pero puede conectar a los estudiantes con el apoyo adecuado y escalar problemas de las plataformas.',
        'View Support Session Flyer': 'Ver Volante de Sesiones de Apoyo',
        'One-on-one support': 'Apoyo individual',
        'Individual Appointments': 'Citas Individuales',
        'Tuesdays, 9:00-11:00 AM, or Wednesdays, 1:00-3:00 PM': 'Martes, 9:00-11:00 AM, o miercoles, 1:00-3:00 PM',
        'Schedule a private session for signup help or questions.': 'Programa una sesion privada para recibir ayuda con la inscripcion o resolver preguntas.',
        'Schedule an Appointment': 'Programar una Cita',
        'Drop-in support': 'Apoyo sin cita',
        'Weekly Friday Zoom': 'Zoom Semanal de los Viernes',
        'Fridays, 1:00-3:00 PM': 'Viernes, 1:00-3:00 PM',
        'Drop in for general dual enrollment help and questions.': 'Entra para recibir ayuda general con la inscripcion doble y resolver preguntas.',
        'Join Friday Office Hours': 'Entrar a las Horas de Oficina del Viernes',
        ...
        'Do not use your teacher. Your counselor is': 'No uses a tu maestro. Tu consejero es',
        'Mr. Sutherland': 'Sr. Sutherland',
        ...
        'Course:': 'Curso:',
        'Class number:': 'Numero de clase:',
        'Important: do not use your teacher. Your counselor is Mr. Sutherland.': 'Importante: no uses a tu maestro. Tu consejero es el Sr. Sutherland.',
        ...
        'Use this information when the form asks for your high school counselor or high school contact. Important: do not use your teacher. Your counselor is Mr. Sutherland.': 'Usa esta informacion cuando el formulario pida tu consejero o contacto de preparatoria. Importante: no uses a tu maestro. Tu consejero es el Sr. Sutherland.',
        ...
        'Early College Credit Support Sessions': 'Sesiones de Apoyo de Credito Universitario Temprano',
        'Appointment times, Friday office hours, and available support': 'Horarios de citas, horas de oficina del viernes y apoyo disponible',
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch('site-data.json?v=20260915-1')
